...
namespace ComplexApi.Controllers
{
    ...
    */
    public class BuildingsController : ODataController
    {
        ...
        {
            return SingleResult.Create(db.Buildings.Where(building => building.buildingId == key));
        }
        ...
        {
            return SingleResult.Create(db.Buildings.Where(m => m.buildingId == key).Select(m => m.Complex));
        }
